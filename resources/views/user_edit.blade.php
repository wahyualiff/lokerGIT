        ...
        <div class="card-body">
            <form action="{{route('user.update', $users->id) }}" method="POST">
                ...
                <ul class="list-group">
                    ...
                    Akses 
                    <select name="role" class="form-group" id="">
                    ...
                    Jenis Kelamin
                    <select name="jenis_kelamin" class="form-group" id="">
                    ...
                    Status 
                    <select name="status" class="form-group" id="">
                    ...
                    Pendidikan Terakhir 
                    <select name="pendidikan" class="form-group" id="">
