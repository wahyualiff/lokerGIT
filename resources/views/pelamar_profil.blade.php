        ...
        <div class="card-body">
            <form action="{{ Auth::user()->id }}" method="POST">
                ...
                <ul class="list-group">
                    ...
                    Alamat <input type="text" name="alamat" required value="{{ Auth::user()->alamat }}">
                    Kota 
                    <select name="kota" id="">
                    ...
                    Tempat Lahir <input type="text" name="tempat_lahir" required value="{{ Auth::user()->tempat_lahir }}">
                    Tanggal Lahir <input type="date" name="tgl_lahir" required value="{{ Auth::user()->tgl_lahir }}">
                    Status 
